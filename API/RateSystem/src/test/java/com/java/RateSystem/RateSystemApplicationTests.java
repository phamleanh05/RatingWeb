...
class RateSystemApplicationTests {
	...
	Rating rate2 = new Rating(1, 1, 1, 1, 1,"Amazone EC2", "SomeOne", 5.0, "Good Service", Localdate1);
	Rating rate3 = new Rating(300, 1, 1, 1, 1, "Amazone EC2","SomeOne", 1.0, "Bad Service", Localdate2);
	@InjectMocks
